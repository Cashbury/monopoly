  ...
  def money_account_at_large
	...
	def snapped_qrcode(qr_code,associatable,place_id,lat,lng)
      ...
      Account.transaction do
        ...
        after_fees_amount=transaction_type.fee_amount.nil? ? associatable.amount : associatable.amount-transaction_type.fee_amount
        ...
        business_account.decrement!(:amount,associatable.amount)
