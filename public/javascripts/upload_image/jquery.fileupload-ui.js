    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            // Callback for successful uploads:
                ...
                var that = $(this).data('fileupload');
                if (data.context) {
                    $(".L-current_image").html("<img src='"+data.result.current_image+"'>");
                    ...
                    "http://s3.amazonaws.com/cashbury-dev/users/720/normal/winnie%20the%20pooh%20theme.jpg"
                    /*
        ...
        _renderUpload: function (files) {
            ...
            tmpl.find('.progress div').slice(
                ...
                .progressbar();
            /*
            tmpl.find('.approve button').slice(
            ...
            tmpl.find('.cancel ').slice(1).remove().end().first()
                .button({
                    text: false,
